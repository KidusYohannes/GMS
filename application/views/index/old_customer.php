...
<section class="content-header">
    <h1>
        Incoming Vehicle
        <small>for existing customers</small>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="btn-group">
        <a class="btn btn-primary btn-sm" href="<?= base_url() ?>incomming/">New Incoming</a>
...
<section class="content">
    <div class="row container-fluid">
    		...
    		<div class="box-body">
    			<div class="form-horizontal">
    				...
    				<div class="form-group col-lg-4 col-md-4 col-sm-4">
    					<input type="text" id="name" class="form-control input-sm" name="" placeholder="Enter Customer Name Here ... .. ..">
    				</div>
    				<div class="col-lg-5 col-md-5 col-sm-5">
    					<div class="input-group">
							<input type="text" id="id" class="form-control input-sm col-sm-10 col-lg-10 col-md-10" name="" placeholder="Enter Customer id here ... .. ..">
        ...
        <form action="<?= base_url() ?>incomming/old_customer/" class="form-horizontal" method="post">
                                        ...
                                        <div class="box-group" id="accordion">
                                                ...
                                                <div id="collapseOne" class="panel-collapse collapse in">
                                                    <div class="box-body">
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                            <input type="text" name="Company" id="Company" disabled class="form-control input-sm" placeholder="Company Name">
                                                        </div>
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                            <input type="text" name="First_Name" id="First_Name" disabled class="form-control input-sm" placeholder="First Name">
                                                        </div>
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                            <input type="text" name="Last_Name" id="Last_Name" disabled class="form-control input-sm" placeholder="Last Name">
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                                            <input type="text" name="Sex" id="Sex" disabled class="form-control input-sm" placeholder="Sex">
                                                        </div>
                                                        <div class="form-group col-lg-7 col-md-7 col-sm-7">
                                                            <input type="date" name="DOB" id="DOB" disabled class="form-control input-sm" placeholder="Date Of Birth" value="<?= date('Y-m-d') ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapseTwo" class="panel-collapse collapse">
                                                    <div class="box-body">
                                                        <div class="form-group col-lg-7 col-md-7 col-sm-7">
                                                            <input type="text" name="Region" id="Region" disabled class="form-control input-sm" placeholder="Region">
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                                            <input type="text" name="Subcity" id="Subcity" disabled class="form-control input-sm" placeholder="Subcity">
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                                            <input type="text" name="Wereda" id="Wereda" disabled class="form-control input-sm" placeholder="Wereda .. ">
                                                        </div>
                                                        <div class="form-group col-lg-7 col-md-7 col-sm-7">
                                                            <input type="tel" name="Phone" id="Phone" disabled class="form-control input-sm" placeholder="Phone">
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                                            <input type="tel" name="Phone_O" id="Phone_O" disabled class="form-control input-sm" placeholder="Office Phone">
                                                        </div>
                                                        <div class="form-group col-lg-7 col-md-7 col-sm-7">
                                                            <input type="email" name="Email" id="Email" disabled class="form-control input-sm" placeholder="Email">
                                                        </div>
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                                            <input type="text" name="Web" id="Web" disabled class="form-control input-sm" placeholder="website">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="box-group" id="accordion1">
                                            <div class="panel box box-primary">
                                                ...
                                                <div id="collapsefour" class="panel-collapse collapse in">
                                                    <div class="box-body">
                                                        <div class="form-group col-lg-7  col-md-7 col-sm-7">
                                                            <input type="text" name="Model" class="form-control input-sm" placeholder="Vehicle Model">
                                                        </div>
                                                        <div class="form-group col-lg-6  col-md-6 col-sm-6">
                                                            <input type="text" name="Make" class="form-control input-sm" placeholder="Make">
                                                        </div>
                                                        <div class="form-group col-lg-7  col-md-7 col-sm-7">
                                                            <select name="Year" id="" class="form-control input-sm" placeholder="Year">
                                                        ...
                                                        <div class="form-group col-lg-6  col-md-6 col-sm-6">
                                                            <input type="text" name="Color" class="form-control input-sm" placeholder="Color">
                                                        </div>
                                                        <div class="form-group col-lg-7 col-md-7 col-sm-7">
                                                            <input type="text" name="Door" class="form-control input-sm" placeholder="Door">
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                                            <input type="text" name="VIN_No" class="form-control input-sm" placeholder="VIN Number">
                                                        </div>
                                                        <div class="form-group col-lg-7 col-md-7 col-sm-7">
                                                            <input type="text" name="Plate_No" class="form-control input-sm" placeholder="Plate Number">
                                                        </div>
                                                        <div class="form-group col-lg-6 col-md-6 col-sm-6">
                                                            <input type="text" name="Chanssis" class="form-control input-sm" placeholder="Chanssis">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
